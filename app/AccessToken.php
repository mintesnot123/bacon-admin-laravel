...
class AccessToken extends Model
{
    ...
    static function init($appID, $appCertificate, $channelName='beacon_message_box', $uid)
    {
    ...
    static function initWithToken($token, $appCertificate, $channel='beacon_message_box', $uid)
    {
        $accessToken = new AccessToken();
    ...
    function extract($token, $appCertificate, $channelName='beacon_message_box', $uid)
    {
        $ver_len = 3;
        $appid_len = 32;
    ...
    function build()
    {
        ...
        $content = array_merge(unpack("C*", $accessToken->packString($sig)), unpack("C*", pack("V", $crc_channel_name)), unpack("C*", pack("V", $crc_uid)), unpack("C*", pack("v", count($msg))), $msg);
        $version = "006";
